...
final class BarController {
    ...
    func resetStatusItemPositions() {
        ...
        statusMessage = "Controls reset — Command-drag the divider and Aster beside each other"
    }
    ...
    private func showContextMenu(from button: NSStatusBarButton) {
        ...
        let settingsItem = NSMenuItem(title: "Open Bar Settings", action: #selector(openSettings), keyEquivalent: "")
        settingsItem.target = self
        menu.addItem(settingsItem)
        let resetItem = NSMenuItem(title: "Reset Aster Control Positions", action: #selector(resetPositionsFromMenu), keyEquivalent: "")
