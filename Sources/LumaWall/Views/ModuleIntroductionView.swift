...
private extension AsterModule {
    var introductionDescription: String {
        ...
        case .keys: "A searchable shortcut cheat sheet you can shape around the way you work."
    ...
    var introductionSteps: [String] {
        ...
        case .keys:
            ["Browse or search the Mac cheat sheet.", "Click a key combination to record your own.", "Restore any shortcut to its default with one click."]
        case .home, .ask:
    ...
    var introductionShortcuts: [ModuleIntroductionShortcut] {
        ...
        case .keys:
            [ModuleIntroductionShortcut(keys: "⌘7", label: "Open Keys")]
        case .home, .ask:
            []
        }
    }
    ...
    var introductionPrivacyNote: String {
        ...
        case .keys: "Your customized shortcut reference stays on this Mac."
